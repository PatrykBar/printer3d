package pl.patrykbartnicki.printersoft.printer3d.dataFiller;
...
public class DataFiller implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadHumidity(){
        ...
        humidityRepository.save(humidity0);
